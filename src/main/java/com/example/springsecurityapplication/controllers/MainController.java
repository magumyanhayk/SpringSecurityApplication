...
// Мейн контроллер отвечает за авторизованного пользователя (КУ)
@Controller
...
//    }
    ...
    // Добавление товара в карзину ссылкной на странице товара (комментарий ученика)
    ...
    // Собиарение карзины (комментарий ученика)
    @GetMapping("/cart")
